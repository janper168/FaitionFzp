...
using System.IO;
using JKF.Utils.Shared;
using JKF.Utils.Extensions;
using JKF.Utils.Internal;
using JKF.Utils.Extensions.Internal;

namespace JKF.Utils
{
    public class EncryptProvider
    {
        private static string desEncryptKey = "6ql7ehNxJStPNEF6YmshjM3l";
        #region Common
