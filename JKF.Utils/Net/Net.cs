    ...
    public class Net
    {
        ...
        public static string Ip
        {
            get
            {
                ...
                if (new HttpContextAccessor().HttpContext != null)
        ...
        private static string GetWebRemoteIp()
        {
            ...
            return accessor.HttpContext.Request.Headers["X_FORWARDED_FOR"].ToString() ??
                accessor.HttpContext.Request.Headers["REMOTE_ADDR"].ToString();
        }
        ...
        public static string Host
        {
            get
            {
                return new HttpContextAccessor().HttpContext == null ? Dns.GetHostName() : GetWebClientHostName();
            }
        }
        ...
        private static string GetWebClientHostName()
        {
            ...
            if (accessor.HttpContext.Request.Host.Host == "127.0.0.1" ||
                accessor.HttpContext.Request.Host.Host == "localhost")
                return string.Empty;
            var ip = GetWebRemoteIp();
        ...
        public static string Browser
        {
            get
            {
                ...
                if (accessor.HttpContext == null)
                    return string.Empty;
                var browser = accessor.HttpContext.Request.Headers["User-Agent"];
