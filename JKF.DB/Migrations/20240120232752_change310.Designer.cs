...
namespace JKF.DB.Migrations
{
    ...
    [Migration("20240120232752_change310")]
    partial class change310
    {
            ...
            modelBuilder.Entity("JKF.DB.Models.Erp_SalesReturnGoods", b =>
                {
                    ...
                    b.Property<string>("SalesGoodsId")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("JKF.DB.Models.Erp_SalesReturnGoods", b =>
                {
                    ...
                    b.HasOne("JKF.DB.Models.Erp_SalesGoods", "SalesGoods")
                        .WithMany()
                        .HasForeignKey("SalesGoodsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
