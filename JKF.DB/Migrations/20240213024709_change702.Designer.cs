...
namespace JKF.DB.Migrations
{
    ...
    [Migration("20240213024709_change702")]
    partial class change702
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JKF.DB.Models.ChatMessage", b =>
                {
            ...
            modelBuilder.Entity("JKF.DB.Models.ChatSession", b =>
                {
                    b.Property<string>("ChatSessionId")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("JKF.DB.Models.ChatUserSession", b =>
                {
                    b.Property<string>("ChatUserSessionId")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
                    ...
                    b.HasKey("ChatUserSessionId");

                    b.HasIndex("ChatSessionId");

                    b.HasIndex("ChatUserId");

                    b.ToTable("ChatUserSession");
                });
            ...
            modelBuilder.Entity("JKF.DB.Models.Erp_ChargeOrder", b =>
                {
                    b.Property<string>("Erp_ChargeOrderId")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
                    ...
                    b.Property<string>("ChargeItemId")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");

                    b.Property<string>("ChargeItemName")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("JKF.DB.Models.Erp_SysSettings", b =>
                {
                    b.Property<string>("Erp_SysSettingsId")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
                    ...
                    b.HasKey("Erp_SysSettingsId");

                    b.ToTable("Erp_SysSettings");
                });
            ...
            modelBuilder.Entity("JKF.DB.Models.User", b =>
                {
                    ...
                    b.Property<string>("ColorCssName")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("JKF.DB.Models.ChatMessage", b =>
                {
                    b.HasOne("JKF.DB.Models.ChatSession", "ChatSession")
                        .WithMany()
                        .HasForeignKey("ChatSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JKF.DB.Models.User", "SendUser")
                        .WithMany()
            ...
            modelBuilder.Entity("JKF.DB.Models.ChatUserSession", b =>
                {
                    b.HasOne("JKF.DB.Models.ChatSession", "ChatSession")
                        .WithMany("ChatUserSessionList")
                        .HasForeignKey("ChatSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JKF.DB.Models.User", "ChatUser")
                        .WithMany()
            ...
            modelBuilder.Entity("JKF.DB.Models.Erp_ChargeOrder", b =>
                {
                    ...
                    b.HasOne("JKF.DB.Models.Erp_ChargeItem", "ChargeItem")
                        .WithMany()
            ...
            modelBuilder.Entity("JKF.DB.Models.Erp_CollectionAccount", b =>
                {
                    ...
                    b.HasOne("JKF.DB.Models.Erp_CollectionOrder", "CollectionOrder")
                        .WithMany("CollectionAccountList")
            ...
            modelBuilder.Entity("JKF.DB.Models.Erp_StockTransferGoods", b =>
                {
                    ...
                    b.HasOne("JKF.DB.Models.Erp_StockTransferOrder", "StockTransferOrder")
                        .WithMany("StockTransferGoodsList")
                        .HasForeignKey("StockTransferOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JKF.DB.Models.ChatSession", b =>
                {
                    b.Navigation("ChatUserSessionList");
                });
            ...
            modelBuilder.Entity("JKF.DB.Models.Erp_CollectionOrder", b =>
                {
                    b.Navigation("CollectionAccountList");
                });
            ...
            modelBuilder.Entity("JKF.DB.Models.Erp_StockTransferOrder", b =>
                {
                    b.Navigation("StockTransferGoodsList");
                });
